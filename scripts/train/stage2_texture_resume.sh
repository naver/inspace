...
# Usage:
#   bash scripts/train/stage2_texture_resume.sh              # uniform sampling (default)
#   bash scripts/train/stage2_texture_resume.sh weighted      # weighted sampling (oversample large rooms)
...
OUTPUT_DIR="results/erp_slat_flow_imgshape2tex_asset_aware_bf16"
DATA_DIR="datasets/ERP_3D_FRONT"
EVAL_DATA_DIR="datasets/ERP_3D_FRONT_test"

# Resume settings
LOAD_DIR="results/erp_slat_flow_imgshape2tex_asset_aware_bf16"
CKPT="latest"
