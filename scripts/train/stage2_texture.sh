...
# Usage:
#   bash scripts/train/stage2_texture.sh              # uniform sampling (default)
#   bash scripts/train/stage2_texture.sh weighted      # weighted sampling (oversample large rooms)
...
echo "=========================================="
echo "  Stage: 2-2 (Texture Generation)"
echo "  CONFIG: $CONFIG"
